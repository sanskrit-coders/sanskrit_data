...
:py:mod:`~sanskrit_data.db.interfaces` define these interfaces, while :py:mod:`~sanskrit_data_implementations.db` contain the database-specific implementations.
"""
